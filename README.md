...
Для локальной разработки бэкенд должен быть запущен на порту 5000, а в файле src/services/api.ts должен быть указан адрес http://localhost:5000. В продакшене используется бэкенд на Railway — https://finikvest-backend-production.up.railway.app.
