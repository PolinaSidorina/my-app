export const quests = [
  //localStorage.removeItem('questProgress');
  {
    ...
    steps: [
      {
        type: 'info',
        text: '💰 Фини — это деньги внутри приложения. Их можно зарабатывать и тратить.',
      },
      {
        type: 'highlight',
        target: 'balance',
        text: '👆 Это твой баланс. Здесь видно, сколько у тебя всего денег.',
      },
      {
        type: 'info',
        text: 'Когда ты тратишь деньги, баланс уменьшается. Если денег не хватает — покупка не пройдет.',
      },
      {
        type: 'highlight',
        target: 'covers',
        text: '📦 Это конверты. Они помогают не тратить всё сразу.',
      },
      {
        type: 'info',
        text: 'Каждый конверт — для своей цели: накопления, покупки, развлечения и добрые дела.',
      },
      {
        type: 'choice',
        question: '🧐 Если у тебя 50 Фини, можно ли потратить 70?',
        options: [
      ...
      {
        type: 'complete',
        text: '🎉 Ура! Ты узнал, как работают деньги в игре. Получи награду!',
      },
    ],
  },
  {
